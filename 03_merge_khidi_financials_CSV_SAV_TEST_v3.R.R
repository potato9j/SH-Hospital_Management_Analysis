...
# 0) 사용자 설정 -----------------------------------------------------------
# 중요:
# Windows 경로는 반드시 아래 둘 중 하나로 입력하세요.
#   방법 1: / 사용
#     data_dir <- "G:/A1_대학교/3-1/병원경영분석/1_기말프로젝트/0_자료모음/B_KHIDI_재무상태표&손익계산서"
#   방법 2: R 4.0 이상 raw string 사용
#     data_dir <- r"(G:\A1_대학교\3-1\병원경영분석\1_기말프로젝트\0_자료모음\B_KHIDI_재무상태표&손익계산서)"
#
# 아래 경로를 본인 컴퓨터의 실제 폴더 경로로 수정하세요.
