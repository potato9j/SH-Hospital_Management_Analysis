...
#
# v2 수정사항:
#   - jsonlite 패키지를 필수 패키지에 추가
#   - readxl/tibble 열 추출 오류 방지를 위해 raw[[열번호]][행번호] 방식 사용
#   - 파일명에 공백/복사본 표시가 있어도 손익계산서/재무상태표를 더 넓게 인식
#   - 120개 조합이 맞지 않으면 누락 병원-연도-재무제표 종류를 콘솔에 출력하고 중단
# =============================================================================

# 0) 사용자 설정 -------------------------------------------------------------
# Windows 경로는 반드시 \ 대신 /를 쓰세요.
# 예: "G:/A1_대학교/3-1/병원경영분석/1_기말프로젝트/0_자료모음/B_KHIDI_재무상태표&손익계산서"
